...
from network.PMLNet import PMLNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=int, default=50, help='50') #change
    parser.add_argument('--lr', type=float, default=5e-4, help='learning rate')#change
    parser.add_argument('--batchsize', type=int, default=8, help='8') #change
    parser.add_argument('--trainsize', type=int, default=256, help='training dataset size')
    parser.add_argument('--clip', type=float, default=0.5, help='gradient clipping margin')
    parser.add_argument('--decay_rate', type=float, default=0.1, help='decay rate of learning rate')
    parser.add_argument('--decay_epoch', type=int, default=50, help='every n epochs decay learning rate')#change if you want more epochs
    parser.add_argument('--gpu_id', type=str, default='0', help='0')  #change
    parser.add_argument('--data_name', type=str, default='WHU', #change
                        help='the test rgb images root')
    parser.add_argument('--model_name', type=str, default='PMLNet',
                        help='the test rgb images root')
    ...
    if opt.model_name == 'PMLNet':
        model = PMLNet().cuda()
    elif opt.model_name == 'FMENet':
        model = FMENet().cuda()
